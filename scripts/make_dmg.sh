...
cd "$(dirname "$0")/.."
APP_PATH="dist/Tome.app"
DMG_PATH="dist/Tome.dmg"
...
hdiutil create -volname "Tome" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "Tome"
    ...
    set position of item "Tome.app" of container window to {120, 150}
